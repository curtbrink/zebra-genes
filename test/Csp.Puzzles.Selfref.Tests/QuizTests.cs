...
using Csp.Puzzles.Selfref.Builders;
using Csp.Puzzles.Selfref.Constraints;

namespace Csp.Puzzles.Selfref.Tests;
...
public class QuizTests
{
    ...
    public void TestSelfReferencingVeryEasy()
    {
        ...
        var domain = new ImmutableDomain<string>("A", "B", "C", "D", "E");
        ...
        var csp = new BaseCsp<string>(allQs, domain, allConstraints);
    ...
    public void TestSelfReferencingMedium()
    {
        ...
        var csp = new BaseCsp<string>(questions, domain, constraints);
    ...
    //     var twoA = (IOrderedVariable me, IDomainStore<string> domains) =>
    //     {
